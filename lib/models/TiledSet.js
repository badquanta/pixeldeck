...
class TiledSet extends require('./TiledModel') {
  ...
  static async createSchemaOn (table) {
    ...
    table.json('tileoffset') // TODO: Look more into offset: https://docs.mapeditor.org/en/stable/reference/tmx-map-format/#tmx-tileoffset
    table.integer('tilewidth')
    table.string('transparentcolor')
    table.string('type')
    // TODO: Handle Wangsets better
    table.json('wangsents') // TODO: https://docs.mapeditor.org/en/stable/reference/json-map-format/#json-wangset
