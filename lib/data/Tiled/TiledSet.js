/**
 * TileSet
 * Uses [TileSet](https://doc.mapeditor.org/en/stable/reference/json-map-format/#tileset) definitions
 */
const data = require('../../data')

/**
 * @extends {pixeldeck.data.Model}
 * @name {pixelmap.data.TiledSet}
 */
class TiledSet extends data.Model {
  ...
  /**
   * defines members:
   * @member {Array<pixeldeck.data.TileMapUsesTileSet>} tileMapUsage
   * @member {Array<pixeldeck.data.TileMap>} usedBy
   */
    ...
    return {
      ...
      usedBy: {
        ...
        join: {
          from: 'TileSet.uuid',
          through: {
            className: 'TileMapUsesTileSet',
            from: 'TileMapUsesTileSet.TileSetUuid',
...
const dbg = data.dbg.extend(TiledSet.name)
