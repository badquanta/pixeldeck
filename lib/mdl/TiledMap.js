 ...
 * @property {integer} hexsidelength
 * @property {boolean} infinite
 * @property {mdl.TiledLayer[]} layers
 * @property {integer} nextlayerid
 * @property {integer} nextobjectid
 * @property {string} orientation
 * @property {mdl.TiledProperties[]} properties
 * @property {string} renderorder
 * @property {string} staggeraxis
 * @property {string} staggerindex
